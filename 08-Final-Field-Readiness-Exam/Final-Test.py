...
class Encryption():
    ...
    def encryption(self,message):
        ...
        for i in range(len(message)):
            # putting the first element in to output and it is a str object
            # so we can use concate str1 + str2 methode later
            output += message[i]
            # firt part returns a list so we have to use [0] to choose a element
    ...
    def decryption(self,message,seed):
        ...
        # First undo the randomized Caeser cipher
